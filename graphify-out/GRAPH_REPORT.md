...
## Corpus Check
- 8 files · ~12,079 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 335 nodes · 708 edges · 21 communities (16 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9b1ca5f`
...
Cohesion: 0.12
Nodes (16): List all supported sites and sources., List all supported sites and sources., List all supported sites and sources., List all supported sites and sources., List all supported sites and sources., List all supported sites and sources., List all supported sites and sources., List all supported sites and sources. (+8 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (24): AppleMusicResolver, ArchiveOrgResolver, _artist_values(), BlockedSourceResolver, _fallback_resolved_source(), _fallback_title(), hostname(), is_apple() (+16 more)

### Community 2 - "Community 2"
Cohesion: 0.16
Nodes (21): _feeds_from_public_search(), _find_episode(), from_env(), http_json(), _match_episode_id_from_feed(), normalize_match_text(), _open_graph_metadata(), _parse_url() (+13 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (48): _artist_values_from_info(), _artist_values_from_track(), _audio_codec(), _audio_extension_from_url(), build_parser(), bundled_ffmpeg_path(), _burn_subtitles(), clean_filename() (+40 more)

### Community 4 - "Community 4"
Cohesion: 0.12
Nodes (21): _clean_oembed_title(), _embed_metadata(), _episode(), _extract_identifier(), _fallback_podcast(), _fetch_metadata(), _filter_media_files(), _get_json() (+13 more)

### Community 5 - "Community 5"
Cohesion: 0.18
Nodes (4): ConsoleDownloadReporter, format_duration(), progress_bar(), ReferenceDownloadReporter
...
Cohesion: 0.16
Nodes (11): is_url(), M3UPlaylistResolver, _parse_m3u(), _playlist_title(), PodcastQueryResolver, Resolver for M3U/M3U8 playlists (IPTV streams, HLS playlists, local media lists), Resolver for M3U/M3U8 playlists (IPTV streams, HLS playlists, local media lists), Resolver for M3U/M3U8 playlists (IPTV streams, HLS playlists, local media lists) (+3 more)
...
Cohesion: 0.12
Nodes (21): Exception, _client_credentials_token(), _curl_progress_fraction(), DependencyMissingError, _download_direct_audio_with_curl(), MetadataResolutionError, _progress_fraction(), Base error for expected application failures. (+13 more)
...
## Knowledge Gaps
- **109 isolated node(s):** `Base error for expected application failures.`, `Raised when a required local executable or API credential is missing.`, `Raised when a source cannot be resolved by the configured resolvers.`, `Raised when metadata lookup fails for a supported source.`, `Resolver for M3U/M3U8 playlists (IPTV streams, HLS playlists, local media lists)` (+104 more)
